...
namespace UC_GestionPerso
{
    ...
    public partial class GestionPerso : UserControl
    {
        ...
        private UCRichButton SelectedPompier;
        ...
        private void UCGestionPerso_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                while(data.Read())
                {
                    ...
                    btn.Tag = id;
                    btn.clickReturnTag += btnClickForCaserne;
        ...
        private void btnClickForCaserne(UCRichButton clicked, object tag)
        {
        ...
        {
            if(SelectedPompier != null && clicked != SelectedPompier)
            {
                SelectedPompier.isSelected = false;
                SelectedPompier.BackColor = Color.White;
                SelectedPompier.ForeColor = Color.Black;
            }
            clicked.isSelected = true;
            SelectedPompier = clicked;
            formPompier();
        }
        ...
        private void formPompier()
        {
            try
            {
                ...
                var varimg = SAE_Aparcio_Claudel_Meral.Properties.Resources.ResourceManager.GetObject(codeGradeInit);
                if(varimg is Image img)
                {
                    pic.Image = img;
                }
                ...
                {
                    pic.Image = SAE_Aparcio_Claudel_Meral.Properties.Resources.Default;
                }
                if(login.Connected)
                {
